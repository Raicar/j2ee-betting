package es.udc.isg011.apuestas.test.model.userservice;
...
import es.udc.isg011.apuestas.model.userservice.IncorrectPasswordException;
...
public class UserServiceTest {
    ...
    private final long NON_EXISTENT_CATEGORY = -1;
    ...
    @Test
    public void testRegisterUserCheckVirtualAccount() throws DuplicateInstanceException, InstanceNotFoundException{
        ...
        VirtualAccount virtualAccount2 = virtualAccountDao.find(virtualAccount.getVirtualAccountId());
        
        assertEquals(virtualAccount, virtualAccount2);
        
        assertTrue(virtualAccount.getBalance()==0);
    }
	...
	public void testObtainCategories() {
		...
		List<Category> l2 = userService.obtainCategories();
	...
	@Test
	public void testObtainCategoriesEmptyList() {
		List<Category> l1 = new ArrayList<Category>();
		List<Category> l2 = userService.obtainCategories();
	...
	//TESTS EXISTSCATEGORY
	@Test
	public void existsCategory(){
		Category c1 = new Category("name1");
		categoryDao.save(c1);
		assertEquals(true,userService.existsCategory(c1.getCategoryId()));
	}
	
	@Test
	public void existsCategoryWithNonExistentCategory(){
		assertEquals(false,userService.existsCategory(NON_EXISTENT_CATEGORY));
	}
}
